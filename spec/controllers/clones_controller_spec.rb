...
describe ClonesController do
  context "when signed out" do
    context "on POST to create" do
      before do
        post :create, :tree_id => 123, :node_id => 456
      end
  ...
  context "signed in with a tree and nodes" do
    ...
    context "on successful POST to #create with a tree_id, node_id, and a new parent_id" do
      before do
      ...
      it "should find trees on the current user" do
        user.should have_received(:trees).with()
