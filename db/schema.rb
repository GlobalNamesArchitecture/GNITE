...
ActiveRecord::Schema.define(version: 20120731151204) do
  ...
  add_index "action_commands", ["tree_id"], name: "index_action_commands_on_tree_id", using: :btree
  ...
  add_index "bookmarks", ["node_id"], name: "index_bookmarks_on_node_id", using: :btree
  ...
  add_index "controlled_terms", ["controlled_vocabulary_id"], name: "index_controlled_terms_on_controlled_vocabulary_id", using: :btree
  ...
  add_index "gnaclr_publishers", ["master_tree_id"], name: "index_gnaclr_publishers_on_master_tree_id", using: :btree
  ...
  add_index "master_tree_contributors", ["user_id", "master_tree_id"], name: "index_master_tree_contributors_on_user_id_and_master_tree_id", unique: true, using: :btree
  ...
  add_index "merge_events", ["master_tree_id"], name: "index_merge_events_on_master_tree_id", using: :btree
  ...
  add_index "merge_result_secondaries", ["merge_decision_id"], name: "index_merge_results_secondaries_2", using: :btree
  add_index "merge_result_secondaries", ["merge_type_id", "merge_subtype_id"], name: "index_merge_results_secondaries_1", using: :btree
  ...
  add_index "names", ["name_string"], name: "index_names_on_name_string", unique: true, using: :btree
  ...
  add_index "nodes", ["local_id", "tree_id"], name: "index_nodes_on_local_id_and_tree_id", using: :btree
  add_index "nodes", ["name_id"], name: "index_nodes_on_name_id", using: :btree
  ...
  add_index "redo_action_commands", ["master_tree_id", "action_command_id"], name: "index_redo_action_commands_on_master_tree_and_action_command", using: :btree
  ...
  add_index "reference_tree_collections", ["master_tree_id", "reference_tree_id"], name: "index_rtc_on_master_tree_id_etc", unique: true, using: :btree
  ...
  add_index "rosters", ["master_tree_id", "user_id"], name: "index_rosters_on_master_tree_id_and_user_id", using: :btree
  ...
  add_index "synonyms", ["node_id", "name_id"], name: "index_synonyms_on_node_id_and_name_id", unique: true, using: :btree
  ...
  add_index "trees", ["revision", "id"], name: "index_trees_on_revision_and_id", using: :btree
  ...
  add_index "vernacular_names", ["node_id", "name_id"], name: "index_vernacular_names_on_node_id_and_name_id", unique: true, using: :btree
